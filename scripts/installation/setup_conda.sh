...
# Default RECIPE 'factual_knowledge_probing' can be overridden by 'RECIPE' environment variable
RECIPE=${RECIPE:-factual_knowledge_probing}
# Default ENV_NAME 'factual_knowledge_probing' can be overridden by 'ENV_NAME'
